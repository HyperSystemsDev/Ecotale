...
public class TransactionLogger {
    ...
    private MongoDBStorageProvider mongoStorage;
    ...
    /**
     * Set the MongoDB storage provider for persistent logging.
     * Called by EconomyManager after initialization.
     */
    public void setMongoStorage(MongoDBStorageProvider storage) {
        this.mongoStorage = storage;
    }
    
    /**
     * Set the MySQL storage provider for persistent logging.
     * Called by EconomyManager after initialization.
     */
    ...
    private void log(TransactionEntry entry) {
        ...
        // Write to MongoDB (async, for persistent LOG tab)
        if (mongoStorage != null) {
            mongoStorage.logTransaction(entry);
        }
        // Write to MySQL (async, for persistent LOG tab)
        if (mysqlStorage != null) {
            mysqlStorage.logTransaction(entry);
        }
    }
    /**
